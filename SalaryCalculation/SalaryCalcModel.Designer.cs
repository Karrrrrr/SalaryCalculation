// Создание кода T4 для модели "D:\Документы\Шарага\Учебная практика\Практическая работа 6\SalaryCalculation\SalaryCalculation\SalaryCalcModel.edmx" включено. 
